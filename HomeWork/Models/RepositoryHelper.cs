namespace HomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static NewTableRepository GetNewTableRepository()
		{
			var repository = new NewTableRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static NewTableRepository GetNewTableRepository(IUnitOfWork unitOfWork)
		{
			var repository = new NewTableRepository();
